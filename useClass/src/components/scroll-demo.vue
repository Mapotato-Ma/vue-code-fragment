  ...
  <div class="box">
    ...
    <div class="scroll-demo" @scroll.passive="onScroll" ref="container">
      ...
      <div class="row" v-for="(row, rowIndex) in data" :key="rowIndex">
        <div class="col col-sticky" :style="{ transform: calcTranslateX }">第{{ rowIndex + 1 }}行</div>
...
const data = new Array(10).fill(0).map(() => new Array(10).fill(0).map(() => Math.floor(Math.random() * 10)));
const scrollX = ref(0);
